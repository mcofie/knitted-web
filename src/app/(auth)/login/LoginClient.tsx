    ...
    return (
        <div
            ...
            <div className="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
                ...
                <div className="relative z-20 mt-auto">
                    <blockquote className="space-y-2">
                        <p className="text-lg">
                            &ldquo;Tailoring isn&apos;t just about stitching fabric; it&apos;s about weaving stories.
                            Knitted helps you manage the narrative.&rdquo;
                        </p>
                        <footer className="text-sm text-zinc-300">The Knitted Team</footer>
                    </blockquote>
                </div>
            </div>
            ...
            <div className="lg:p-8">
                <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[380px] px-4 sm:px-0">
                    ...
                    {err && (
                        <div
                            className="p-3 text-sm text-red-500 bg-red-50 border border-red-200 rounded-md dark:bg-red-900/20 dark:border-red-900/50">
                            {err}
                        </div>
                    )}
