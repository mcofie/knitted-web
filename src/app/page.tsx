    ...
    return (
        <main className="bg-background text-foreground min-h-screen flex flex-col">
            ...
            >
                <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-2 md:px-6">
                    ...
                    <Link href="/" className="flex items-center gap-2">
                        ...
                        >
                            <Image src="/logo.svg" alt="Knitted Logo" width={32} height={32} />
                    ...
                    <nav className="hidden items-center gap-6 md:flex">
                        {links.map((l) => {
                            ...
                            return (
                                <Link key={l.href} href={l.href} className="relative text-sm font-medium text-muted-foreground hover:text-foreground">
                  <span className="relative inline-block">
                    ...
                    <div className="flex items-center gap-3">
                        <Link href="https://apps.apple.com/app/your-app" aria-label="Download on App Store" className="hidden md:inline-flex">
                            <Image src="/images/badges/appstore.svg" alt="Download on the App Store" width={110} height={36} />
                        </Link>
                        <Link href="https://play.google.com/store/apps/details?id=your.app" aria-label="Get it on Google Play" className="hidden md:inline-flex">
                            <Image src="/images/badges/googleplay.svg" alt="Get it on Google Play" width={120} height={38} />
                        </Link>

                        <Link href="/login" className="text-sm font-medium text-muted-foreground hover:text-primary">
                            Sign in
                        </Link>
                        <Link href="/signup" className="rounded-md bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground hover:opacity-90">
                            Sign up
                        </Link>
                    </div>
                </div>
            ...
            <div aria-hidden className="pointer-events-none fixed inset-0 -z-10">
                <div className="absolute -top-20 -left-20 h-80 w-80 rounded-full bg-gradient-to-br from-primary/25 via-indigo-500/20 to-purple-500/20 blur-3xl" />
                <div className="absolute -bottom-24 -right-24 h-96 w-96 rounded-full bg-gradient-to-tr from-secondary/25 via-indigo-500/20 to-purple-500/20 blur-3xl" />
            </div>

            {/* ============================ Hero ============================ */}
            <section className="relative overflow-hidden">
                <div className="absolute inset-0 -z-10 bg-gradient-to-br from-primary/15 via-indigo-500/10 to-purple-500/10 dark:from-primary/25 dark:via-indigo-400/15 dark:to-purple-400/15" />
                <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 py-20 md:grid-cols-2 md:px-6 md:py-24">
                    <motion.div variants={stagger} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.4 }}>
                        ...
                        <motion.p variants={fadeUp} className="mt-4 max-w-prose text-muted-foreground">
                            Knitted is your modern atelier — manage clients, measurements, and orders with quiet precision.
                        </motion.p>
            ...
            <section className="relative border-t overflow-hidden">
                ...
                <div className="mx-auto max-w-6xl px-4 py-16 md:px-6 md:py-20">
                    <motion.div initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.4 }} className="mb-10 text-center">
                        ...
                        {[
                            {
                                ...
                                img: '/images/landing/feature-clients.png',
                            },
                            {
                                ...
                                img: '/images/landing/feature-orders.png',
                            },
                            {
                                ...
                                img: '/images/landing/feature-reports.png',
                            },
                        ].map((f, i) => (
                            <motion.div
                                key={f.title}
                            ...
                            >
                                ...
                                <motion.div variants={fadeUp} className="rounded-[var(--radius-lg)] border bg-card p-2 shadow-sm">
                                    <Image
                                        src={f.img}
                                        alt={f.title}
                                        width={1200}
            ...
            <section className="relative border-t overflow-hidden">
                <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
                    <div className="absolute left-1/2 top-0 h-[520px] w-[820px] -translate-x-1/2 -translate-y-1/3 rounded-full bg-[radial-gradient(closest-side,theme(colors.indigo.500)/12%,transparent)] dark:bg-[radial-gradient(closest-side,theme(colors.indigo.400)/16%,transparent)] blur-2xl" />
                </div>
                    ...
                    >
                        {[
                            ...
                            >
                                ...
                                <div className="mb-6 bg-gradient-to-r from-primary to-secondary bg-clip-text text-3xl font-bold text-transparent">
                                    {t.price}
                                </div>
                ...
                <div className="mx-auto max-w-6xl px-4 py-16 text-center md:px-6 md:py-20">
                    ...
                    >
                        <Link
                            ...
                            className="inline-flex items-center gap-3 rounded-[var(--radius)] border bg-card px-4 py-3 text-sm font-semibold transition hover:bg-card/80"
                        >
                            <Image alt="Download on the App Store" src="/images/badges/appstore.svg" width={140} height={44} />
                        </Link>
                        <Link
                            href="https://play.google.com/store/apps/details?id=your.app"
                            className="inline-flex items-center gap-3 rounded-[var(--radius)] border bg-card px-4 py-3 text-sm font-semibold transition hover:bg-card/80"
                        >
                            <Image alt="Get it on Google Play" src="/images/badges/googleplay.svg" width={150} height={46} />
                        </Link>
                    </motion.div>
                </div>
            </section>
            ...
            <section className="relative border-t overflow-hidden">
                <div aria-hidden className="absolute inset-0 -z-10">
                    <div className="absolute inset-x-0 top-0 h-2/5 bg-gradient-to-b from-purple-500/10 via-indigo-500/10 to-transparent dark:from-purple-400/15 dark:via-indigo-400/15" />
                </div>
                <div className="mx-auto max-w-6xl px-4 py-16 md:px-6 md:py-20">
                    <motion.div initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.4 }} className="mb-10 text-center">
                        <motion.h2 variants={fadeUp} className="text-3xl font-bold tracking-tight md:text-4xl">
                        ...
                        {[
                            ...
                            >
                                <div className="mb-4 flex items-center gap-3">
                                    <div className="h-10 w-10 rounded-full bg-gradient-to-br from-primary/40 to-secondary/40" />
                                    <div>
                ...
                <div className="mx-auto max-w-6xl px-4 py-10 text-center md:px-6">
                    <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                        <div className="flex flex-col items-center md:items-start">
                            <Image src="/logo.svg" alt="Knitted Logo" width={32} height={32} />
                            <p className="mt-2 text-sm text-muted-foreground">© {new Date().getFullYear()} Knitted. All rights reserved.</p>
                        </div>
